...
def load_cifar_data(config: DictConfig):
    ...
    trainloader = torch.utils.data.DataLoader(
        trainset, batch_size=config.train.batch_size, shuffle=True, num_workers=config.train.dataloader_workers
    )
    testloader = torch.utils.data.DataLoader(
        testset, batch_size=config.train.batch_size, shuffle=True, num_workers=config.train.dataloader_workers
    )

    data = {"train": trainloader, "validation": testloader}
    return data
